...
> ⚠️ 此中文翻译落后于英文 README（缺 Stitch 风格 UI、可点击 tier 卡、Fast/Medium/Quality 命名、五个 mascot 头像、越南语支持等更新）。当前功能请以 [English README](../README.md) 为准。社区翻译 PR 欢迎。
...
| 写出不同场景的文本 | 支持 Message、Email、Raw、Prompt 等模式。 |
